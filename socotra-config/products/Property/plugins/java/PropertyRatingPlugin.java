...
//                // TODO: seek clarification on construciton class causing issues for doc testing
//                BigDecimal loiGroup1 = new BigDecimal("1.0");
...
//                BigDecimal loiGroup2 = new BigDecimal("1.0");
...
////                                                .multiply(loiGroup2)))
////                                        .divide(classBaseRateGroups, 2, RoundingMode.HALF_EVEN);
//                BigDecimal loiBuildings = new BigDecimal("1.0");
//                log.info("loi buildings: {}", loiBuildings);
//                BigDecimal loiContents1 = new BigDecimal("1.0");
...
//                BigDecimal loiContents2 = new BigDecimal("1.0");
...
//                BigDecimal loiContents = new BigDecimal("1.0");
//
...
//                int roofAgeAsNumber = Integer.parseInt(roofAge);
//                if (roofAgeAsNumber > 10) {
//                    if (roofAgeAsNumber <= 12) {
//                        roofAge = "11-12";
//                    } else if (roofAgeAsNumber <= 14) {
//                        roofAge = "13-14";
//                    } else if (roofAgeAsNumber <= 18) {
//                        roofAge = "15-18";
//                    } else if (roofAgeAsNumber <= 22) {
//                        roofAge = "19-22";
//                    } else if (roofAgeAsNumber<= 26) {
//                        roofAge = "23-26";
//                    } else if (roofAgeAsNumber <= 30) {
//                        roofAge = "27-30";
//                    } else if (roofAgeAsNumber <= 999) {
//                        roofAge = "31-999";
//                    }
//                }
